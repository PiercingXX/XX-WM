...
- **Local-only customization.** Themes, fonts, layout, and gestures live in plain text files under `~/.config/piercing-shell/` (see `docs/config.md`) and hot-reload while you edit. Nothing phones home.
