...
#
# Generated by pywayland 0.4.18 scanner from the protocol XMLs vendored in
# this repo at launcher/data/. Combined into one module to match
# wlr_foreign_toplevel_management_unstable_v1.py.
#
#   sed 's/ interface="wl_object"//g' launcher/data/wayland.xml > /tmp/wayland.xml
#   python -m pywayland.scanner -o /tmp/proto \
#       -i /tmp/wayland.xml launcher/data/wlr-screencopy-unstable-v1.xml
#
# Do not edit.
...
from .wayland import WlBuffer, WlOutput
